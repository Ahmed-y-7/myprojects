        ...
        <div class="card">
            <div class="text-center">
                ...
                <h3 class="mt-4 font-weight-bold">
                    {{ auth()->user()->name }}  <!--هذا لعرض اسم المستخدم -->
            </div>
            <div class="card-body text-right">
                ...
                <div class="form-group">
                    ...
                    <!--هذه كود عشان تظهر رسالة الخطا لو ترك المستخدم الحقل فارغ -->
                    @error('name')
                ...
                <div class="form-group">
                    <label for="password-confirmation">تاكيد من كلمة المرور</label>
                ...
                <div class="form-group d-flex mt-5 flex-row-reverse">
                    <button type="submit" class="btn btn-primary mr-2">حفظ التغيرات</button>
